...
#<----------------CSV FILE FUNCTIONS-------------------------------------------------->  
    ...
    def add_round_to_csv(self,msg:list) -> None:
        """ The msg should contain in order: 
        "Player 1 total cards","Player 2 total cards",
        "Player 1 card","Player 2 card","Winner","War"""
...
#<----------------PLAY FUNCTIONS-------------------------------------------------->      
    def check_turn_winner(self,player1_card:namedtuple,player2_card:namedtuple,
        ...
        player1_total_turn_cards = self.player1_total_cards + len(player1_face_down_cards) if war \
                                   else self.player1_total_cards + 1 + len(player1_face_down_cards)
        player2_total_turn_cards = self.player2_total_cards + len(player2_face_down_cards) if war \
                                   else self.player2_total_cards + 1 + len(player2_face_down_cards)
        ...
        # last option is war
            ...
            self.war(player1_card, player2_card, continuing_card_index,
                     prev_player1_face_down_cards = player1_face_down_cards,
                     prev_player2_face_down_cards = player2_face_down_cards)
        time.sleep(2)
    ...
    def war(self,player1_card:namedtuple,player2_card:namedtuple,continuing_card_index:int,
            prev_player1_face_down_cards:list = [],prev_player2_face_down_cards:list = []) -> None:
        ...
        # also add any previous face down cards
        if len(prev_player1_face_down_cards):
            player1_face_down_cards.extend(prev_player1_face_down_cards)
        if len(prev_player2_face_down_cards):
            player2_face_down_cards.extend(prev_player2_face_down_cards)
